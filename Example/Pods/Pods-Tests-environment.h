...
// BBForm
#define COCOAPODS_POD_AVAILABLE_BBForm
#define COCOAPODS_VERSION_MAJOR_BBForm 0
#define COCOAPODS_VERSION_MINOR_BBForm 1
#define COCOAPODS_VERSION_PATCH_BBForm 0
